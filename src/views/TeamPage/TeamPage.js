  ...
  const certificates = [
    {
      ...
      src: '/images/TeamPage/Riza_Saglam_Certificate.jpeg'
    },
    {
      id: 'internal-auditor',
      type: 'pdf',
        ...
        <div className="team-member-card">
          <div className="member-image">
            <div className="member-placeholder">
              <OptimizedImage
                src="/images/TeamPage/riza-saglam.webp"
    ...
    },
    {
      ...
      content: (
        <div className="cta-content">
          ...
          <LocaleLink href={ctaData.buttonLink} className="btn-cta">{ctaData.buttonText}</LocaleLink>
        </div>
      )
    }
  ];
