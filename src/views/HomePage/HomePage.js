...
function HomePage() {
  ...
  const carouselSlideData = [
    {
      ...
      backgroundImage: '/images/HomePage/mwd-hizmetleri.webp',
    ...
    },
    {
      ...
      slideKey: 'slide2_5',
      button: { type: "link", to: "/drilling-services" },
      backgroundImage: '/images/HomePage/tunel-delme-hizmetleri.webp',
      icon: "fas fa-road"
    },
    {
      id: 3,
      ...
      slideKey: 'slide2_6',
      button: { type: "link", to: "/drilling-services" },
      backgroundImage: '/images/HomePage/acik-saha-delme-hizmetleri.webp',
    ...
    },
    {
      ...
      backgroundImage: '/images/HomePage/quarry-blasting2.webp',
      icon: "fas fa-mountain"
    },
    {
      id: 5,
      ...
      backgroundImage: '/images/HomePage/urban-blasting.webp',
      icon: "fas fa-city"
    },
    {
      id: 6,
      ...
      backgroundImage: '/images/HomePage/sualti3.webp',
      icon: "fas fa-water"
    }
  ];
        ...
        <div key={service.id} className="card-custom service-card-custom">
          <div className="card-custom__body">
            ...
            {service.link.type === 'link' ? (
              <LocaleLink href={service.link.to} className="btn-custom btn-secondary-custom">{service.link.text}</LocaleLink>
            ) : (
  ...
  const structuredData = {
    ...
    "sameAs": [
      ...
      "https://www.instagram.com/saglamdp/"
    ],
    "serviceArea": {
      "@type": "Country",
      "name": "Türkiye"
              ...
              <div key={slide.id} className={`carousel-item ${slide.isActive ? 'active' : ''}`}>
                <div className="hero-slide">
                  <OptimizedImage
                    ...
                    alt={slide.imageTitle || slide.title}
                    fill
                    priority={index === 0}
                    sizes="100vw"
                      ...
                      <div className="col-lg-6">
                        ...
                        <div className="btn-group-custom">
                          {slide.button.type === 'link' ? (
                            <LocaleLink href={slide.button.to} className="btn-custom btn-outline-custom btn-custom--lg">
        ...
        <div className="container-custom">
          <div className="flex flex--center flex--between">
            ...
            <div className="text-right">
              <LocaleLink href="/contact" className="btn-custom btn-light-custom btn-custom--lg btn-custom--icon">
