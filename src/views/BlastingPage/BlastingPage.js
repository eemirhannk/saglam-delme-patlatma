...
function BlastingPage() {
  ...
  const urbanImages = [
    {
      id: 1,
      src: '/images/BlastingPage/sehiricipatlatma.webp',
      alt: t('images.urban1')
    },
    {
      id: 2,
      src: '/images/BlastingPage/sehiricipatlatma2.webp',
      alt: t('images.urban2')
    }
  ];
  ...
  return (
    <div className="blasting-page">
      ...
      <section id="quarry-blasting" className="quarry-image-container">
          <OptimizedImage
            src="/images/BlastingPage/quarry-blasting2.webp"
            alt={t('images.quarry')}
      ...
      <section id="underwater-blasting" className="underwater-blasting-section">
        <div className="underwater-image-container">
          <OptimizedImage
            src="/images/BlastingPage/sualti3.webp"
            alt={t('images.underwater')}
